          ...
          <>
            ...
            >
             ...
             <GlowingEffect {...glowingEffectProps} />
                ...
                <div className="relative bg-[#0E0C15]  rounded-2xl shadow-[0_0_30px_#00D2FF33] overflow-hidden"
                >
       ...
       style={{
         ...
         padding: "2px"
                  ...
                  <div className="sticky top-0 flex items-center justify-between p-5 border-b border-[#00D2FF]/30">
                    ...
                    <button
                      onClick={() => setShowForm(false)}
                      className="text-gray-400 hover:text-[#00D2FF] transition relative"
                    >
                      <X size={24} />
                    </button>
                  </div>
                    ...
                    {submitStatus === "success" ? (
                      ...
                      >
                        ...
                        <p className="text-gray-400">
                          Thank you for enrolling — our team will reach out
                          soon.
                        </p>
                      </motion.div>
                    ) : (
                      <form onSubmit={handleSubmit} className="space-y-5">
                        <input
                          ...
                          required
                          className="w-full px-4 py-2 bg-[#1A1825] border border-[#00D2FF]/30 rounded-lg text-white placeholder-gray-500"
                        />
                        <input
                          type="email"
                          name="email"
                        ...
                        <textarea
                          ...
                          rows={3}
                          className="w-full px-4 py-2 bg-[#1A1825] border border-[#00D2FF]/30 rounded-lg text-white placeholder-gray-500 resize-none"
                        />

                        <button
                          type="submit"
                          disabled={isSubmitting}
                          className="w-full py-3 mt-6 bg-white text-black font-semibold rounded-lg hover:bg-[#00D2FF]/80 transition flex items-center justify-center gap-2"
                        >
                          {isSubmitting ? (
                            <>
